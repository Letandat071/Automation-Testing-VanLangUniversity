...
public class Xemnamhoc_ThinhGiang_XemTheoCa {
...
//	@Test (priority = 77)
//	public void xemnamhocthinhgiangbieudo() throws IOException, InterruptedException {
//		Thread.sleep(2000);
//		System.out.println("Test case 78: Xem theo năm học - Thỉnh giảng - biểu đồ -> Xem theo ca giảng");
...
//	@Test (priority = 78)
//	public void xemnamhocthinhgiangbangbieu() throws IOException, InterruptedException {
//		Thread.sleep(2000);
//		System.out.println("Test case 79: Xem theo năm học - Thỉnh giảng - bảng biểu -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	@Test (priority = 79)
//	public void xemnamhocthinhgiangchitiet() throws IOException, InterruptedException {
//		Thread.sleep(2000);
//		System.out.println("Test case 80: Xem theo năm học - Thỉnh giảng - chi tiết -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	@Test (priority = 80)
//	public void xemnamhocthinhgiangbangbieusodulieu() throws IOException, InterruptedException {
//		Thread.sleep(2000);
//		System.out.println("Test case 81: Xem theo năm học - Thỉnh giảng - bảng biểu - so du lieu -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	@Test (priority = 81)
//	public void xemnamhocthinhgiangbangbieusearch() throws IOException, InterruptedException {
//		Thread.sleep(2000);
//		System.out.println("Test case 82: Xem theo năm học - Thỉnh giảng - bảng biểu - Search -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	@Test (priority = 82)
//	public void xemnamhocthinhgiangbangbieusearch() throws IOException, InterruptedException, AWTException, UnsupportedFlavorException {
//		Thread.sleep(2000);
//		System.out.println("Test Case 83: Xem theo năm học - Thỉnh giảng - bảng biểu - Export -> print -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	public void xemnamhocthinhgiangbangbieusearch() throws IOException, InterruptedException, AWTException, UnsupportedFlavorException {
//		Thread.sleep(2000);
//		System.out.println("Test Case 84: Xem theo năm học - Thỉnh giảng - bảng biểu - Export -> sao chép -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	@Test (priority = 84)
//	public void xemnamhocthinhgiangchitietsodulieu() throws IOException, InterruptedException {
//		Thread.sleep(2000);
//		System.out.println("Test case 85: Xem theo năm học - Thỉnh giảng - chi tiết - so du lieu -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	@Test (priority = 85)
//	public void xemnamhocthinhgiangchitietsearch() throws IOException, InterruptedException {
//		Thread.sleep(2000);
//		System.out.println("Test case 86: Xem theo năm học - Thỉnh giảng - chi tiết - Search -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	@Test (priority = 86)
//	public void xemnamhocthinhgiangchitietsearch() throws IOException, InterruptedException, AWTException, UnsupportedFlavorException {
//		Thread.sleep(2000);
//		System.out.println("Test Case 87: Xem theo năm học - Thỉnh giảng - chi tiết - Export -> print -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	public void xemnamhocthinhgiangbangbieusearch() throws IOException, InterruptedException, AWTException, UnsupportedFlavorException {
//		Thread.sleep(2000);
//		System.out.println("Test Case 88: Xem theo năm học - Thỉnh giảng - chi tiết - Export -> sao chép -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
