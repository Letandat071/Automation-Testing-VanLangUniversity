...
public class Xemhocky_CoHuu_XemTheoCa {
...
//		Thread.sleep(2000);
//		System.out.println("Test case 45: Xem theo Học Kỳ - Cơ hữu - biểu đồ -> Xem theo ca giảng");
...
//		Thread.sleep(2000);
//		System.out.println("Test case 46: Xem theo học kỳ - cơ hữu - bảng biểu -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 47: Xem theo học kỳ - cơ hữu - chi tiết -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 48: Xem theo học kỳ - cơ hữu - bảng biểu - so du lieu -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 49: Xem theo học kỳ - cơ hữu - bảng biểu - Search -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test Case 50: Xem theo học kỳ - cơ hữu - bảng biểu - Export -> print -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	public void xemhockycohuubangbieusearch() throws IOException, InterruptedException, AWTException, UnsupportedFlavorException {
//		Thread.sleep(2000);
//		System.out.println("Test Case 51: Xem theo học kỳ - cơ hữu - bảng biểu - Export -> sao chép -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 52: Xem theo học kỳ - cơ hữu - chi tiết - so du lieu -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 53: Xem theo học kỳ - cơ hữu - chi tiết - Search -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test Case 54: Xem theo học kỳ - cơ hữu - chi tiết - Export -> print -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	public void xemhockycohuubangbieusearch() throws IOException, InterruptedException, AWTException, UnsupportedFlavorException {
//		Thread.sleep(2000);
//		System.out.println("Test Case 55: Xem theo học kỳ - cơ hữu - chi tiết - Export -> sao chép");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
