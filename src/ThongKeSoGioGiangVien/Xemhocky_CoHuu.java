...
//		Thread.sleep(2000);
//		System.out.println("Test case 1: Xem theo Học Kỳ - Cơ hữu - biểu đồ ");
...
//		Thread.sleep(2000);
//		System.out.println("Test case 2: Xem theo học kỳ - cơ hữu - bảng biểu ");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 3: Xem theo học kỳ - cơ hữu - chi tiết ");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 4: Xem theo học kỳ - cơ hữu - bảng biểu - so du lieu ");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 5: Xem theo học kỳ - cơ hữu - bảng biểu - Search ");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test Case 6: Xem theo học kỳ - cơ hữu - bảng biểu - Export -> print ");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	public void xemhockycohuubangbieusearch() throws IOException, InterruptedException, AWTException, UnsupportedFlavorException {
//		Thread.sleep(2000);
//		System.out.println("Test Case 7: Xem theo học kỳ - cơ hữu - bảng biểu - Export -> sao chép ");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 8: Xem theo học kỳ - cơ hữu - chi tiết - so du lieu");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 9: Xem theo học kỳ - cơ hữu - chi tiết - Search ");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test Case 10: Xem theo học kỳ - cơ hữu - chi tiết - Export -> print ");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	public void xemhockycohuubangbieusearch() throws IOException, InterruptedException, AWTException, UnsupportedFlavorException {
//		Thread.sleep(2000);
//		System.out.println("Test Case 11: Xem theo học kỳ - cơ hữu - chi tiết - Export -> sao chép");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
