...
public class Xemnamhoc_ThinhGiang {
...
//		Thread.sleep(2000);
//		System.out.println("Test case 34: Xem theo năm học - Thỉnh giảng - biểu đồ ");
...
//		Thread.sleep(2000);
//		System.out.println("Test case 35: Xem theo năm học - Thỉnh giảng - bảng biểu ");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 36: Xem theo năm học - Thỉnh giảng - chi tiết");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 37: Xem theo năm học - Thỉnh giảng - bảng biểu - so du lieu");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 38: Xem theo năm học - Thỉnh giảng - bảng biểu - Search ");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test Case 39: Xem theo năm học - Thỉnh giảng - bảng biểu - Export -> print");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	public void xemnamhocthinhgiangbangbieusearch() throws IOException, InterruptedException, AWTException, UnsupportedFlavorException {
//		Thread.sleep(2000);
//		System.out.println("Test Case 40: Xem theo năm học - Thỉnh giảng - bảng biểu - Export -> sao chép");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 41: Xem theo năm học - Thỉnh giảng - chi tiết - so du lieu");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 42: Xem theo năm học - Thỉnh giảng - chi tiết - Search ");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test Case 43: Xem theo năm học - Thỉnh giảng - chi tiết - Export -> print");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	public void xemnamhocthinhgiangbangbieusearch() throws IOException, InterruptedException, AWTException, UnsupportedFlavorException {
//		Thread.sleep(2000);
//		System.out.println("Test Case 44: Xem theo năm học - Thỉnh giảng - chi tiết - Export -> sao chép");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
