...
public class Xemhocky_ThinhGiang_XemTheoCa {
...
//		Thread.sleep(2000);
//		System.out.println("Test case 56: Xem theo Học Kỳ - Thỉnh giảng - biểu đồ -> Xem theo ca giảng");
...
//		Thread.sleep(2000);
//		System.out.println("Test case 57: Xem theo học kỳ - Thỉnh giảng - bảng biểu -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 58: Xem theo học kỳ - Thỉnh giảng - chi tiết -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 59: Xem theo học kỳ - Thỉnh giảng - bảng biểu - so du lieu -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 60: Xem theo học kỳ - Thỉnh giảng - bảng biểu - Search -> Xem theo ca giảng ");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test Case 61: Xem theo học kỳ - Thỉnh giảng - bảng biểu - Export -> print -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	public void xemhockycohuubangbieusearch() throws IOException, InterruptedException, AWTException, UnsupportedFlavorException {
//		Thread.sleep(2000);
//		System.out.println("Test Case 62: Xem theo học kỳ - Thỉnh giảng - bảng biểu - Export -> sao chép -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 63: Xem theo học kỳ - Thỉnh giảng - chi tiết - so du lieu -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test case 64: Xem theo học kỳ - Thỉnh giảng - chi tiết - Search -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//		Thread.sleep(2000);
//		System.out.println("Test Case 65: Xem theo học kỳ - Thỉnh giảng - chi tiết - Export -> print -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
...
//	public void xemhockycohuubangbieusearch() throws IOException, InterruptedException, AWTException, UnsupportedFlavorException {
//		Thread.sleep(2000);
//		System.out.println("Test Case 66: Xem theo học kỳ - Thỉnh giảng - chi tiết - Export -> sao chép -> Xem theo ca giảng");
//		// Nhập dữ liệu từ file
//		FileInputStream fis = new FileInputStream("D:\\TEST\\TestData\\So_Gio_GV.xlsx");
//	    XSSFWorkbook workbook = new XSSFWorkbook(fis);
//	    XSSFSheet sheet = workbook.getSheetAt(0);
