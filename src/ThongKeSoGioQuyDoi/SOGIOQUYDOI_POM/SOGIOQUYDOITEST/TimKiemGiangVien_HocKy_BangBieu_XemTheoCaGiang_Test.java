...
import SOGIOQUYDOI.TimKiemGiangVien_HocKy_BangBieu_Page;
import SOGIOQUYDOI.TimKiemGiangVien_HocKy_BangBieu_XemTheoCaGiang_Page;
...
public class TimKiemGiangVien_HocKy_BangBieu_XemTheoCaGiang_Test {
	...
	public void SearchBangBieu1() throws InterruptedException, IOException {
		Thread.sleep(2000);
		System.out.println("Testcase 1:Tìm kiếm với Hiển thị 10 dữ liệu theo Học Kỳ, bảng biểu và xem theo ca giảng");
	...
	public void SearchBangBieu2() throws InterruptedException, IOException {
		System.out.println("Testcase 2:Tìm kiếm với Hiển thị 25 dữ liệu theo Học Kỳ, bảng biểu và xem theo ca giảng");
		Thread.sleep(2000);
	...
	public void SearchBangBieu3() throws InterruptedException, IOException {
		Thread.sleep(2000);
		System.out.println("Testcase 3:Tìm kiếm với Hiển thị 50 dữ liệu theo Học Kỳ, bảng biểu và xem theo ca giảng");
		WebElement dropdown = driver.findElement(By.xpath("//*[@id=\"tblStatistics_length\"]/label/select"));
		Select select = new Select(dropdown);
	...
	public void SearchBangBieu4() throws InterruptedException, IOException {
		Thread.sleep(2000);
		System.out.println("Testcase 4:Tìm kiếm với Hiển thị tất cả dữ liệu theo Học Kỳ, bảng biểu và xem theo ca giảng");
		WebElement dropdown = driver.findElement(By.xpath("//*[@id=\"tblStatistics_length\"]/label/select"));
		Select select = new Select(dropdown);
	...
	public void SearchBangBieu5() throws InterruptedException, IOException {
		Thread.sleep(2000);
		System.out.println("Testcase 5:Tìm kiếm với Hiển thị 10 dữ liệu với ký tự đặc biệt theo Học Kỳ, bảng biểu và xem theo ca giảng");
		FileInputStream fis = new FileInputStream("K:\\Automation\\SearchSoGioQuyDoi.xlsx");
		XSSFWorkbook workbook = new XSSFWorkbook(fis);
		XSSFSheet sheet = workbook.getSheetAt(0);
	...
	public void SearchBangBieu6() throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		System.out.println("Testcase 6:Tìm kiếm với Hiển thị 25 dữ liệu với ký tự đặc biệt theo Học Kỳ, bảng biểu và xem theo ca giảng");
		WebElement dropdown = driver.findElement(By.xpath("//*[@id=\"tblStatistics_length\"]/label/select"));
		Select select = new Select(dropdown);
		select.selectByValue("25");
		Thread.sleep(2000);
	...
	public void SearchBangBieu7() throws InterruptedException, IOException {
		Thread.sleep(2000);
		System.out.println("Testcase 7:Tìm kiếm với Hiển thị 50 dữ liệu với ký tự đặc biệt theo Học Kỳ, bảng biểu và xem theo ca giảng");
		WebElement dropdown = driver.findElement(By.xpath("//*[@id=\"tblStatistics_length\"]/label/select"));
		Select select = new Select(dropdown);
		select.selectByValue("50");
		Thread.sleep(2000);
	...
	public void SearchBangBieu8() throws InterruptedException, IOException {
		Thread.sleep(2000);
		System.out.println("Testcase 8:Tìm kiếm với Hiển thị tất cả dữ liệu với ký tự đặc biệt theo Học Kỳ, bảng biểu và xem theo ca giảng");
