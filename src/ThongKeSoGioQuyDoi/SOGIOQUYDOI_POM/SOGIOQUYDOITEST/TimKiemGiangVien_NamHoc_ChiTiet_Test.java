...
import SOGIOQUYDOI.TimKiemGiangVien_NamHoc_ChiTiet_Page;
...
public class TimKiemGiangVien_NamHoc_ChiTiet_Test {
	static WebDriver driver;
		...
		public void SearchBangBieu1() throws InterruptedException, IOException {
			...
			System.out.println("Testcase 1:Tìm kiếm với Hiển thị 10 dữ liệu với Năm học và Chi Tiết");
		...
		public void SearchBangBieu2() throws InterruptedException, IOException {
			...
			System.out.println("Testcase 2:Tìm kiếm với Hiển thị 25 dữ liệu với Năm học và Chi Tiết");
			String pasString = pasStringBuilder.toString();
			String faildString = faildBuilder.toString();
			System.out.println("Key word không hợp lệ " + faildString);
			System.out.println("Key Word hợp lệ " + pasString);
		...
		public void SearchBangBieu3() throws InterruptedException, IOException {
			...
			System.out.println("Testcase 3:Tìm kiếm với Hiển thị 50 dữ liệu với Năm học và Chi Tiết");
			String pasString = pasStringBuilder.toString();
			String faildString = faildBuilder.toString();
			System.out.println("Key word không hợp lệ " + faildString);
			System.out.println("Key Word hợp lệ " + pasString);
		...
		public void SearchBangBieu4() throws InterruptedException, IOException {
			...
			System.out.println("Testcase 4:Tìm kiếm với Hiển thị tất cả dữ liệu với Năm học và Chi Tiết");
			String pasString = pasStringBuilder.toString();
			String faildString = faildBuilder.toString();
			System.out.println("Key word không hợp lệ " + faildString);
			System.out.println("Key Word hợp lệ " + pasString);
		...
		public void SearchBangBieu5() throws InterruptedException, IOException {
			...
			System.out.println("Testcase 5:Tìm kiếm với Hiển thị 10 dữ liệu với ký tự đặc biệt với Năm học và Chi Tiết");
			String pasString = pasStringBuilder.toString();
			String faildString = faildBuilder.toString();
			System.out.println("Key word không hợp lệ " + faildString);
			System.out.println("Key Word hợp lệ " + pasString);
		...
		public void SearchBangBieu6() throws InterruptedException, IOException {
			...
			System.out.println("Testcase 6:Tìm kiếm với Hiển thị 25 dữ liệu với ký tự đặc biệt với Năm học và Chi Tiết");
			String pasString = pasStringBuilder.toString();
			String faildString = faildBuilder.toString();
			System.out.println("Key word không hợp lệ " + faildString);
			System.out.println("Key Word hợp lệ " + pasString);
		...
		public void SearchBangBieu7() throws InterruptedException, IOException {
			...
			System.out.println("Testcase 7:Tìm kiếm với Hiển thị 50 dữ liệu với ký tự đặc biệt với Năm học và Chi Tiết");
			String pasString = pasStringBuilder.toString();
			String faildString = faildBuilder.toString();
			System.out.println("Key word không hợp lệ " + faildString);
			System.out.println("Key Word hợp lệ " + pasString);
		...
		public void SearchBangBieu8() throws InterruptedException, IOException {
			...
			System.out.println("Testcase 8:Tìm kiếm với Hiển thị tất cả dữ liệu với ký tự đặc biệt với Năm học và Chi Tiết");
			String pasString = pasStringBuilder.toString();
			String faildString = faildBuilder.toString();
			System.out.println("Key word không hợp lệ " + faildString);
			System.out.println("Key Word hợp lệ " + pasString);
