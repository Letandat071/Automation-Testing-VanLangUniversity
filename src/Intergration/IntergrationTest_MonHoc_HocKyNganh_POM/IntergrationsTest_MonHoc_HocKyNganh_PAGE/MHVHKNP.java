...
public class MHVHKNP {
    ...
    // Các định danh của các phần tử trên trang web
    ...
    public void themHocKy(String HK) throws InterruptedException, IOException {
        ...
        driver.findElement(By.xpath("/html/body/div[4]/div[2]/div/div[2]/div/span[30]")).click();
    ...
    // Hàm đóng cửa sổ sau khi xóa học kỳ
    ...
    // Click nút Lưu sau khi thêm Ngành
    ...
    // Click nút Hủy sau khi thêm Ngành
    ...
    // Hàm đóng cửa sổ sau khi xóa Ngành
